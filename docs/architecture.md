...
| `amoled-panel-01` | ESPHome | Waveshare ESP32-S3-Touch-AMOLED-1.75C | HA touch control panel ("Garden Panel") | 🚧 Phase 1 bring-up | [`firmware/esphome/amoled-panel-01.yaml`](../firmware/esphome/amoled-panel-01.yaml) |
