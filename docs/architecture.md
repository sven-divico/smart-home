...
| `amoled-panel-01` | ESPHome | Waveshare ESP32-S3-Touch-AMOLED-1.75C | HA touch control panel ("Garden Panel") | ✅ 4-screen swipe panel (plant/weather/forecast/backlight) + battery @ 192.168.178.193 | [`firmware/esphome/amoled-panel-01.yaml`](../firmware/esphome/amoled-panel-01.yaml) |
